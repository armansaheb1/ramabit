...
from .models import timer, Job , pages, bazdid , Subjects ,Tickets, profitlist, AppSettings , settings ,  post ,  bid, Transaction, Addamountreq, Askamountreq , currencies ,  User , Plans , Cat  , wallet ,Verify , Adminverifymelli , Adminverifybank, General, Miners, RentedMiner, News, Banner, Elan, Product,Notification, ProductOrder, Details
...
class UserAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (_("Personal info"), {"fields": ("name", "lastname", "email", "inv", "level1", "level2", "level3")}),
        (
            _("Permissions"),
            {
                "fields": (
